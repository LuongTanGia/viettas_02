      ...
      <div className="col-lg-12 sticky ">
        <div className="card   p-0 m-0">
          <div className="flex gap-2 items-center">
            <BiLeftArrowAlt onClick={() => navigate('/')} /> <h1 className=" text-xl  mr-4">Tồn kho</h1>{' '}
            <Search
              onSearch={onSearch}
          ...
          <Segmented
            options={[
              ...
              {
                label: <p className="w-full text-sm">Tổng hợp theo (đơn vị tính)</p>,
                value: 'Tổng hợp theo (đơn vị tính)',
              },
              {
            ...
            block
            onChange={(value) => {
              setSegmented(value === 'Tổng hợp' ? 'TONGHOP' : value === 'Tổng hợp theo (đơn vị tính)' ? 'TONGHOPDVT' : 'THEOKHO'), setValueSegmented(value)
            }}
